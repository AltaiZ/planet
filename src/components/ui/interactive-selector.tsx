...
import { FaFire, FaTint, FaHotTub } from "react-icons/fa";
import { GiExplodingPlanet, GiSolarSystem, GiStarSwirl } from "react-icons/gi";
  ...
  const options = [
    {
      ...
      image: "/1352911.png",
      icon: <GiExplodingPlanet size={24} className="text-white" />,
      href: "/exoplanet"
    },
    {
      title: "Stars",
      ...
      image: "/sun.jpg",
      icon: <WiStars size={24} className="text-white" />,
      href: '/stars'
    },
    {
      title: "Blackhole Basics",
      description:
        "Concentrations of matter with gravity so powerful not even light can escape.",
      image: "/1289303.png",
      icon: <GiStarSwirl size={24} className="text-white" />,
      href: '/blackhole'
    },
    {
      title: "Solar Systems",
      ...
      image: "/732192.jpg",
      icon: <GiSolarSystem size={24} className="text-white" />,
      href: '/solarsystem'
    },
  ];
...
const handleOptionClick = (index: number) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-black/60 font-sans text-white">
      {/* Header Section */}
      <div className="w-full max-w-2xl px-6 mt-8 mb-2 text-center">
        ...
        <p className="text-lg md:text-xl text-gray-300 font-medium max-w-xl mx-auto animate-fadeInTop delay-600">
          Discover the universe: Learn about the history of the cosmos, what
          it's made of, and so much more.
        </p>
      </div>
        ...
        {options.map((option, index) => (
          <div
            ...
            className={`
              ...
              ${activeIndex === index ? "active !cursor-default" : ""}
            `}
            style={{
          ...
          >
            ...
            <div
              ...
              className="label absolute left-0 right-0 bottom-5 flex items-center justify-start h-12 z-50 px-4 gap-3 w-full cursor-pointer"
            >
              ...
              <div className="info text-white whitespace-pre relative">
                ...
                <div
                  className="sub text-base text-gray-300 transition-all duration-700 ease-in-out truncate max-w-[40vw]"
                  style={{
                    opacity: activeIndex === index ? 1 : 0,
                    transform:
                      activeIndex === index
